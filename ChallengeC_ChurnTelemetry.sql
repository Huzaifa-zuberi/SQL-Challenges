...
-- ============================================================
-- (A) Core Telemetry Query â€” CTE identifying at-risk profiles
...
-- ============================================================
-- (B) Aggregate Filter â€” creators with > 5 assets but < 100
--     cumulative views
-- ============================================================
...
-- ============================================================
-- (C) Interface Layer â€” reusable analytical view
